...
& (Get-Content graphify-out\.graphify_python) -m graphify extract INPUT_PATH --backend gemini
& (Get-Content graphify-out\.graphify_python) -m graphify cluster-only INPUT_PATH
```
